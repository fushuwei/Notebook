...
public class Layout extends BaseDominoElement<HTMLDivElement, Layout> {
    ...
    public Layout(String title) {
        ...
        addExpandListeners();
        if (!bodyStyle().containsCss("ls-hidden"))
            bodyStyle().addCss("ls-closed");
    ...
    /**
     * @return same Layout instance
     * @see {@link org.dominokit.domino.ui.layout.Footer#fixed()}
     */
    ...
    /**
     * @return same Layout instance
     * @see {@link org.dominokit.domino.ui.layout.Footer#unfixed()}
     */
