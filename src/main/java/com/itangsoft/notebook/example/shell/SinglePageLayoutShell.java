...
/**
 * SinglePageLayout Shell
 *
 * @author fushuwei
 */
@Shell(Routes.SHELL_EXAMPLE_LAYOUT)
public class SinglePageLayoutShell extends AbstractShell<AppContext> {
    ...
    public void attachShell() {
        // 设置页眉
        layout.setLogo(Elements.img("images/logo.png?ts=" + System.currentTimeMillis()).element());
        layout.setTitle("云笔记");
        ...
        // 设置左侧面板
        layout.getLeftPanel().setId(Slots.SELECTOR_EXAMPLE_LAYOUT_LEFT_PANEL);

        // 设置主面板
        layout.getContent().setId(Slots.SELECTOR_EXAMPLE_LAYOUT_CONTENT);
    }
